    ...
    <div className='product '>
      ...
      <div className='prdt-detail'>
        ...
        <div className='btn-links'>
          { customer.customer !== null ? <button className="btn btn-outline-danger" onClick={handleCart}>View</button> : <button  onClick={handleEdit}>Edit</button> }
        
        
          <button onClick={addToCart}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-heart-fill" viewBox="0 0 16 16">
