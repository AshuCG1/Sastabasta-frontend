    ...
    <div className='product '>
      ...
      <div className='prdt-detail'>
        ...
        <div className='btn-links'>
          { customer.customer !== null ? <button className="btn btn-outline-danger" onClick={handleCart}>View</button> : <button className="btn btn-outline-danger"  onClick={handleEdit}>Edit</button> }
        
        
          <button className="btn btn-outline-success btn-sm" onClick={addToCart}>Wishlist<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" className="bi bi-bag-heart-fill" viewBox="0 0 16 16">
